function [K_E, K_EF, K_FE, K_F, numberof_nodes_at_ebc, numberof_nodes_at_nbc, Nodes_ID_list_at_ebc, Nodes_ID_list_at_nbc] = func_partitionK(ndof,nnodes,fixnodes_applied, K)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
