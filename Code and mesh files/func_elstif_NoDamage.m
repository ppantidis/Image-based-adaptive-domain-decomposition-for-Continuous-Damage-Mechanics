function [k_el, f_internal_el, damage_el, gausspoints_prop_mat_elem, nodes_prop_mat_elem] = func_elstif_NoDamage(lmncoord,dofs,Delastic,damage_mat_previousinc,alpha_val,beta_val,e_delta,dmax,n_hood,weights,IsM,IsProj)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
