function [dofs_partitioned, dofs_E, dofs_F, numberof_nodes_at_ebc, numberof_nodes_at_nbc, Nodes_ID_list_at_ebc, Nodes_ID_list_at_nbc] = func_partitiond_fixnodes(ndof,nnodes,fixnodes_applied, dofs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
